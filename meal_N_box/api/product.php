...
{
    $sqlcommand= "SELECT * FROM `featured_product` f join productmenu_table p on f.Menu_ID = p.Menu_ID group by p.Menu_ID";
...
{
    $sqlcommand= "SELECT * FROM `productmenu_table`;";
